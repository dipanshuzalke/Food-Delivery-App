      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Discover the best food vendors on campus, check menus, and find great deals
          </p>
          ...
          <Link to="/client/vendors">
            <Card className="hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">Browse All Vendors</h3>
                <p className="text-gray-600">Explore all food options on campus</p>
              </CardContent>
            </Card>
          </Link>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredVendors.map((vendor) => (
              <Link key={vendor.id} to={`/client/vendor/${vendor.id}`}>
